...
public class ChooseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(R.style.AppTheme_NoActionBar); //Setting normal theme after our "splashscreen"
        ...
        */
        MapFragmentPagerAdapter mMapFragmentPagerAdapter = new MapFragmentPagerAdapter(getSupportFragmentManager());
    ...
    /**
     * Extracts selected addresses and starts ResultActivity
     * @return true if both addresses are present, false otherwise
     */
    ...
    private class MapFragmentPagerAdapter extends FragmentPagerAdapter {
        //contains references to MapFragments, to get selected addresses
        ...
        SparseArrayCompat<MapFragment> getFragments() {
